...
public class EnemyDeathEffect : MonoBehaviour
{
    ...
    IEnumerator DeathSequence()
    {
        ...
        // NULL GUARD IS REQUIRED — missing scripts return null from GetComponents
        // and mb.enabled = false would throw NullReferenceException without it.
        ...
        if (rb2 != null) { rb2.linearVelocity = Vector2.zero; rb2.simulated = false; }
    ...
    IEnumerator DoScreenFlash()
    {
        ...
        while (elapsed < screenFlashDuration)
        {
            ...
            float a = p < 0.2f
                ? Mathf.Lerp(0f, screenFlashIntensity, p / 0.2f)
